...
"Argus","Arlott","Atlas","Aurora","Badang","Balmond","Bane",
"Barats","Baxia","Beatrix","Belerick","Benedetta","Brody",
"Bruno","Carmilla","Cecilion","Chang'e","Chou","Claude",
"Clint","Cyclops","Diggie","Dyrroth","Edith","Esmeralda",
"Estes","Eudora","Fanny","Floryn","Franco","Fredrinn",
"Gatotkaca","Gloo","Gord","Granger","Grock","Guinevere",
"Gusion","Hanabi","Hanzo","Harith","Harley","Hayabusa",
"Helcurt","Hilda","Hylos","Irithel","Ixia","Jawhead",
"Johnson","Joy","Julian","Kadita","Kagura","Kaja",
"Karina","Karrie","Khaleed","Khufra","Kimmy","Lancelot",
"Lapu-Lapu","Layla","Leomord","Lesley","Ling","Lolita",
"Luo Yi","Lylia","Martis","Masha","Mathilda","Melissa",
"Minotaur","Miya","Moskov","Nana","Natalia","Natan",
"Novaria","Odette","Paquito","Pharsa","Popol","Rafaela",
"Roger","Ruby","Saber","Selena","Silvanna","Sun",
"Terizla","Thamuz","Tigreal","Uranus","Valentina",
"Vale","Valir","Vexana","Wanwan","X.Borg","Xavier",
...
function generateHistory(h){
  ...
  for(let i=1;i<=h.win+h.lose;i++){
    ...
    let wr = (winBase/matchBase)*100;
    history.push(wr.toFixed(1));
  }
...
function render(){
  ...
  heroes.forEach((h,i)=>{
    ...
    tbody.innerHTML+=`
    <tr>
    <td onclick="showDetail(${i})" style="cursor:pointer;color:#38bdf8">
      ${h.hero}
    </td>
    <td>${r.match}</td>
